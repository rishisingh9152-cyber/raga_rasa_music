...
var P = ["light", "dark"], E = "(prefers-color-scheme: dark)", Q = typeof window == "undefined", L = import_react.createContext(void 0), D = {
	setTheme: (e) => {},
	themes: []
}, j = () => {
	var e;
	return (e = import_react.useContext(L)) != null ? e : D;
}, z = (e) => import_react.useContext(L) ? e.children : import_react.createElement(O, { ...e }), N = ["light", "dark"], O = ({ forcedTheme: e, disableTransitionOnChange: a = !1, enableSystem: n = !0, enableColorScheme: g = !0, storageKey: m = "theme", themes: c = N, defaultTheme: o = n ? "system" : "light", attribute: y = "data-theme", value: h, children: k, nonce: w }) => {
	let [i, d] = import_react.useState(() => M(m, o)), [S, l] = import_react.useState(() => M(m)), u = h ? Object.values(h) : c, R = import_react.useCallback((s) => {
		let r = s;
		if (!r) return;
		s === "system" && n && (r = T());
		...
		C?.();
	}, []), f = import_react.useCallback((s) => {
		let r = typeof s == "function" ? s(s) : s;
		d(r);
		try {
			localStorage.setItem(m, r);
		} catch (v) {}
	}, [e]), p = import_react.useCallback((s) => {
		l(T(s)), i === "system" && n && !e && R("system");
	}, [i, e]);
	...
	return import_react.createElement(L.Provider, { value: $ }, import_react.createElement(U, {
		forcedTheme: e,
...
}, U = import_react.memo(({ forcedTheme: e, storageKey: a, attribute: n, enableSystem: g, enableColorScheme: m, defaultTheme: c, value: o, attrs: y, nonce: h }) => {
...
//#endregion
export { z as ThemeProvider, j as useTheme };
